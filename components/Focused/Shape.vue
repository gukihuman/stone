    ...
    <div class="w-full relative flex-grow overflow-hidden px-3 py-2">
      <div class="relative overflow-hidden rounded-b-lg scroll-screen h-full">
        <textarea
          ...
          @scroll="onScroll"
          class="w-full h-full py-5 px-8 scroll-screen bg-lines resize-none text-xl bg-stone-600 bg-lines-light selection-light text-stone-300 font-fira rounded-lg"
