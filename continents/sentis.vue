          ...
          <div class="overflow-hidden rounded-lg h-full" @click="onScreenClick">
            <div class="overflow-hidden rounded-lg h-full">
              ...
              <div
                ...
                class="h-full bg-moss-400 text-moss-100 rounded-lg py-5 overflow-y-auto overflow-x-hidden whitespace-pre-wrap scroll-screen bg-screen cursor-default selection-screen text-xl leading-8 text-justify"
                v-html="parsedScreen.html"
              ></div>
              <!-- ### plain mode -->
              <div
                v-else
                class="h-full bg-moss-400 text-moss-100 rounded-lg py-5 px-8 overflow-y-auto overflow-x-hidden whitespace-pre-wrap scroll-screen bg-screen cursor-default selection-screen text-xl leading-8 text-justify"
              >
                {{ screen.content || "" }}
              </div>
            </div>
